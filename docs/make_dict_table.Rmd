...
covars0x = " brainVolume + EDUCYRS + snr + mrimfg +  SEX + ageatimaging "
covars0 = paste("testvol_delta ~ (1|PATNO) + testvol_BL + EDUCYRS + snr + mrimfg + age_BL + SEX" )
...
for (  subtype in subtypes ) {
    ...
    for ( testvols in ( testnames ) ) {
        ...
        # studydata=backimpute( studydata, 'testvol', 'PATNO', 'yearsbl', 
        #    timethresh=1.1, verbose=F )
        ...
        bformx=paste( "testvol~(1|PATNO)+",covarsx, " ")
        myformx=paste( "testvol~(1|PATNO)+",covarsx, " + ( DXSubAsyn )")
