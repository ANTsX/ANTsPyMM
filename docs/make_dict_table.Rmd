...
The `ANTsPyMM` system takes advantage of template-based priors and core T1 processing described in [doi: https://doi.org/10.1101/2023.01.17.23284693](doi: https://doi.org/10.1101/2023.01.17.23284693).
...
* We segment anatomy related to the basal forebrain and associated cholinergic neurons with a deep learning method (`deepNBM`) derived from manual labeling of ADNI data.  
    ...
    * Presented at Human Brain Mapping conference 2022. ![deep NBM](https://github.com/stnava/ANTsPyMM/blob/main/docs/deepnbm.jpg)
