...
zz[ grep("fn",zz$Label),'Measurement']='original T1 filename'
...
A sortable version of the data dictionary is below.

### Table 2

```{r printdict,echo=FALSE}
# DT::datatable(zz)
reactable::reactable( zz , highlight = TRUE, bordered = TRUE, striped = TRUE, compact = FALSE, defaultPageSize = 12000 )
```
