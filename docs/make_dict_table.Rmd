...
```{r lmerex,echo=FALSE,eval=TRUE,fig.width=8,fig.height=4}
#################
clin[ clin$mrimfg == "", "mrimfg"] = "Unk"
clin[ is.na(clin$mrimfg), "mrimfg"] = "Unk"
clin[ clin$mrimodel == "", "mrimodel"] = "Unk"
...
dtinames=getNamesFromDataframe( "DTI"  , dd, exclusions=c("_BL","_delta","cnx","FD","motion","SNR","evr","ssnr","dvars","tsnr","volume",'filename','u_hier_id') )
...
for ( testvols in sample( testnames ) ) {
    ...
    myform="testvol ~ (1|PATNO) + brainVolume_BL + EDUCYRS + age + SEX + meanthick_BL + mrimodel +  yearsbl * DXSubAsyn"
