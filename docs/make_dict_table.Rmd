...
#################################################
commonsel = !is.na(clin$T1Hier_resnetGrade) & fs(clin$T1Hier_resnetGrade >= 1.01)
...
```{r lmerextab,echo=FALSE,eval=runstats,fig.width=12,fig.height=5,message=FALSE,warning=FALSE}
###################################################
...
```{r lmerexallgroups,echo=FALSE,eval=runstats,fig.width=12,fig.height=8,message=FALSE,warning=FALSE}
###################################################
...
```{r printintegrated,echo=FALSE,eval=runstats}
